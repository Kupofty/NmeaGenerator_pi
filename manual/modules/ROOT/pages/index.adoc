...
This manual applies to **version 1.2.1**.

See what's changed in the https://github.com/Kupofty/NmeaGenerator_pi/blob/github-pages/CHANGELOG.md[CHANGELOG].
...
----
git clone --recurse-submodules https://github.com/Kupofty/NmeaGenerator_pi.git
----
...
- **Delete selected target:** Delete the selected AIS target from the list. Can not delete own ship.
...
- **Add AIS targets:** Create a new AIS target (class A, B or ARPA) at the cursor position.
- **Delete AIS targets:** delete the last created AIS target, or remove all AIS targets.
...
[NOTE]
====
Toolbar icon stays highlighted when the window is closed but data is still streaming
====

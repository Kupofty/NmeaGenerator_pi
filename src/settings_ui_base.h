...
class DialogSettingsBase : public wxDialog
{
	...
	public:
		...
		DialogSettingsBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("NmeaGenerator Plugin Preferences"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 296,237 ), long style = wxDEFAULT_DIALOG_STYLE );
